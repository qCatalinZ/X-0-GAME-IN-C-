...
public:
    ...
    short int GetVectorTable(const int &i)
    {
        return VectorTable[i];
    }
    ...
    void ShowTable(const bool &OT/* , const short int &z*/)
    {
...
short int VerifyZ(short int z, const short int *v)
{
    while(v[z])
    {
        if(v[z]==0)
...
short int NavigationRead(const short int *v)
{
    char n;
    short int z;
    for(short int i=0;i<9;++i)
